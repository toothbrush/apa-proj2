...
\author{Jurri\"en Stutterheim\and Ruben de Gooijer (3508617) \and Paul van der Walt (3120805)} 
\date{\today} 
...
%\BinaryInfC{$A\ a \Vdash A\ Maybe(\ a)$}
%\RightLabel{\scriptsize{closure}}
%\UnaryInfC{$A\ (Maybe\ a) \Vdash A\ (Maybe\ (Maybe\ a))$}
%  \AxiomC{$$}
%  \RightLabel{\scriptsize{id}} 
%  \UnaryInfC{$A\ a \Vdash A\ a$}
%    \AxiomC{$instance A\ a \Rightarrow A\ (Maybe\ a)$} 
...
%\BinaryInfC{$A\ a \Vdash A\ (Maybe\ (Maybe\ a))$}
%\RightLabel{\scriptsize{closure}}
%\UnaryInfC{$A\ Int \Vdash A\ (Maybe\ (Maybe\ Int))$}
%  \AxiomC{$$}
%  \RightLabel{\scriptsize{id}}
%  \UnaryInfC{$B\ a \Vdash B\ a$}
%    \AxiomC{$class\ (A\ a) \Rightarrow B\ a$}
%  \BinaryInfC{$B\ a \Vdash A\ a$}
%  \RightLabel{\scriptsize{closure}}
%  \UnaryInfC{$B\ Int \Vdash A\ Int$}
%\RightLabel{\scriptsize{trans}}
%\BinaryInfC{$B\ Int \Vdash A\ (Maybe\ (Maybe\ Int))$}
%\end{prooftree}
