...
\begin{table}
    ...
    \begin{tabular}{lcl}
        $t$ & ::= & $n\: |\: \textbf{ false }\: |\: \textbf{ true }\: |\: x\: |\: \lambda_\pi x.t_1\: |\: \mu f.\lambda_\pi x . t_1$ \\
            ...
            & $|$ & $ (\texttt{ case } e_0 \texttt{ of Pair}(x_1,x_2) \Rightarrow e_1)     $ \\
            & $|$ & $ (\texttt{ case } e_0 \texttt{ of Cons}(x_1,x_2) \Rightarrow e_1 \texttt{ or } e_2)     $ \\
    \end{tabular}
    \caption{Grammar}
    \label{tab:grammar}
\end{table}
...
$[$\emph{cfa-case}$] $& \inference{\widehat{\Gamma} |-_{CFA} t_1:\widehat{\sigma} 
 \widehat{\Gamma}|-_{CFA} t_2 : [\widehat{\sigma}]}
{\widehat{\Gamma} |-_{CFA} t_1 \<:> t_2 :  [\widehat{\sigma}]} \\
    \end{tabular}
